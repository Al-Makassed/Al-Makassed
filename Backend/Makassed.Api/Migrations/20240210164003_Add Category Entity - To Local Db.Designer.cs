...
namespace Makassed.Api.Migrations
{
    ...
    [Migration("20240210164003_Add Category Entity - To Local Db")]
    partial class AddCategoryEntityToLocalDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Makassed.Api.Models.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Makassed.Api.Models.Domain.Field", b =>
                {
                    b.HasOne("Makassed.Api.Models.Domain.Category", "Category")
                        .WithMany("Fields")
